...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_articles_profiles1_idx' => ['type' => 'index', 'columns' => ['trainers_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_articles_profiles1' => ['type' => 'foreign', 'columns' => ['trainers_id'], 'references' => ['trainers', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
